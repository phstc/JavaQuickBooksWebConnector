...
The example.qwc is an example file, which is needed in order to add an application in the QuickBooks Web Connector.
...
I wrote a blog post (in portuguese) with a more detailed explanation about the integration beetween QWC and Java.
http://pablocantero.com/blog/2010/08/17/guia-pratico-do-quickbooks-web-connector-com-java

The blog post below (also in portuguese) shows the Java SE and Spring usage to run this implementation.
