== It's a QuickBooks Web Connector QWC implementation in Java
...
The example.qwc is an example file, that is needed to add an application in the QuickBooks Web Connector
...
You must change this values for your enviroment configuration

Pay attention in AppURL tag, HTTP is only permitted for localhost, for the "internet", you need to use HTTPS
...
This gist https://gist.github.com/703886 contains an example implementation
...
I wrote a blog post (in portuguese) with more detailed explanation about the integration of QWC with Java
http://pablocantero.com/blog/2010/08/17/guia-pratico-do-quickbooks-web-connector-com-java

This blog post (also in portuguese) explains Java SE and Spring usages to run the implementation
